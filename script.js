...
// Tạo label với thông tin đầy đủ (chỉ hiển thị số chunk, bỏ phần trăm)
let labelText = 'Chunk ' + successfulChunks + '/' + supYmMedzDRWZEr;
    ...
    return true; // Trả về true vì đã qua được bước chờ giọng mẫu
        ...
        (function() {
            ...
            function resetAndStartNewRender(newText) {
                ...
                if(progressLabel) {
                    progressLabel.textContent = 'Chunk 0/0';
                }
