...
@media (max-width: 600px) {
    ...
    <div style="margin-bottom: 10px; padding: 10px; background-color: #ffb86c; color: #282a36; border-radius: 6px; font-size: 13px; text-align: center; font-weight: 600;">⚠️ Cảnh báo: Chỉ render dưới 50k ký tự</div>
